...
export const MODULO_LABEL: Record<string, string> = {
  ...
  Cobranca: "Cobrança",
  Plano: "Plano",
  PlanoSala: "Sala do plano",
  Sala: "Sala",
  PlanoAtribuicao: "Atribuição de plano",
  Agendamento: "Agendamento",
  CreditoRemarcacao: "Crédito de remarcação",
  GradeRecorrenteAtendimento: "Grade de atendimento recorrente",
  HorarioAtendimento: "Horário de atendimento",
  DiaFuncionamento: "Dia de funcionamento",
  Feriado: "Feriado",
  Treino: "Treino",
